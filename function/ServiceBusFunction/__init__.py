...
def main(msg: func.ServiceBusMessage):
    ...
    connection = psycopg2.connect(  host="migratedbproject.postgres.database.azure.com",
                                    dbname="techconfdb",
                                    user="legolaskimmy@migratedbproject",
                                    password="Kimmy@5594" )
    ...
    try:
        ...
        for attendee in attendees:
            Mail('{}, {}, {}'.format({'felipelobatodasilva@gmail.com'}, {attendee[2]}, {notification_query}))
